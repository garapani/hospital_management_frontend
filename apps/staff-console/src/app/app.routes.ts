...
export const appRoutes: Route[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'clinical/ot',
        loadComponent: () => import('./ot/ot-list.js').then((m) => m.OtList),
        canActivate: [permissionGuard(Permissions.OT_READ)],
      },
      {
        path: 'clinical/maternity',
        loadComponent: () => import('./maternity/maternity-list.js').then((m) => m.MaternityList),
      ...
      {
        path: 'fixed-assets',
        loadComponent: () => import('./fixed-assets/fixed-assets-console.js').then((m) => m.FixedAssetsConsole),
